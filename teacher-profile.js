const teacherProfiles = {
  ...
  neitzu: {
    name: "念慈老師", role: "舞蹈老師", image: "resume/neitzu_head.jpg", specialty: "彩球啦啦・爵士・國家代表隊",
    education: ["履歷未提供"], highlights: ["現為中華民國啦啦隊國家代表隊國手", "教授科目：彩球啦啦"],
    ...
    certificates: [], stats: [["國手", "國家代表隊"], ["彩球啦啦", "教授科目"], ["多項", "全國賽獲獎"], ["尚無", "教學評分"]]
  }
};
...
document.querySelector("[data-teacher-profile]").innerHTML = `
  ...
  <div class="profile-booking"><button class="button secondary booking-trigger profile-booking-button" type="button" data-teacher-id="${teacherProfiles[id] ? id : 'amber'}" data-teacher-name="${teacher.name}">預約課程</button><p>查看老師月曆，選擇日期與時段後透過 LINE 洽詢。</p></div>
  ...
  <section class="teacher-contact"><div><span>想和 ${teacher.name} 一起上課？</span><h2>告訴我們你的學習目標</h2></div><a class="line-match-button" href="https://line.me/R/share?text=${encodeURIComponent(`您好，我想詢問 ${teacher.name} 的課程。`)}" target="_blank" rel="noopener noreferrer"><img src="line-brand-icon/LINE_Brand_icon.png" alt="LINE">開始體驗 →</a></section>`;
